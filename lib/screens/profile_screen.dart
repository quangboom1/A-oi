                ...
                children: [
                  ...
                  Expanded(
                    child: _buildLargeActionBtn(
                      ...
                      borderColor: _isNotified ? const Color(0xFFDCC79D) : null, // Darker beige for border
                      iconColor: _isNotified ? const Color(0xFFE2BB67) : AppTheme.onSurface,
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            image: DecorationImage(
              image: NetworkImage(widget.imageUrl ?? 'https://api.dicebear.com/7.x/avataaars/png?seed=${widget.username}'),
              fit: BoxFit.cover,
            ),
          ),
        ),
