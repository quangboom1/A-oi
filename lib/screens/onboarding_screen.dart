        ...
        Expanded(
          ...
          child: SafeArea(
            child: Padding(
              padding: EdgeInsets.fromLTRB(
                40,
                Responsive.value(context, mobile: 60, tablet: 80),
                40,
                20,
              ),
              child: Center(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      style: GoogleFonts.inter(
                        fontSize: Responsive.value(context, mobile: 28, tablet: 36, desktop: 42),
                    ...
                    Text(
                      ...
                      textAlign: TextAlign.center,
                      style: GoogleFonts.inter(
                        fontSize: Responsive.value(context, mobile: 15, tablet: 18, desktop: 20),
